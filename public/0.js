...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteFood: function deleteFood() {
      ...
      this.submitRequest = true;
      var url = _apiRoutes__WEBPACK_IMPORTED_MODULE_3__["default"].foods.destroy.url;
      url = url.replace('{0}', this.editedFood.id);
      var method = _apiRoutes__WEBPACK_IMPORTED_MODULE_3__["default"].foods.destroy.method;
      axios[method](url, this.editedFood).then(function () {
        _this2.successMessage('Success', 'The request was succesfull!', 'toast-bottom-left');
        ...
        for (var obj in err.response.data.errors) {
          if (err.response.data.errors.hasOwnProperty(obj)) {
            ...
            _this2.errorMessage(title, err.response.data.errors[obj][0], 'toast-bottom-left');
          }
        }
      })["finally"](function () {
          ...
          _c(
            ...
            [
              ...
              _c(
                ...
                _vm._l(_vm.filterFoods, function(food, index) {
                  return _c(
                    "tr",
                    {
                      key: index,
